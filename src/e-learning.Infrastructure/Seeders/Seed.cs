...

{
    public class Seed : ISeed
    {
        ...
        public Seed(RoleManager<AppRole> roleManager,
        ...
        public async Task SeedCoursesWithDependenciesAsync()
        {
            if (!_context.Instructors.Any())
            {
                ...
                {
                    await _userManager.CreateAsync(instructor, "TEST@test123");
                ...
                {
                    await _userManager.CreateAsync(admin, "TEST@test123");
        ...
        private void buildLessons()
        {
            ...
            {
                var Modules = _context.Modules.Take(12).ToList();
